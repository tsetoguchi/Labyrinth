 ...
 */
public abstract class SimpleCandidateStrategy implements IStrategy {

  /**
   * Gets all candidates to be considered in the desired order.
   */
  abstract protected List<Position> getCandidatesInOrder(ExperimentationBoardProjection board,
      Tile spareTile,
   ...
   */
  @Override
  public Optional<TurnPlan> createTurnPlan(ExperimentationBoardProjection board,
  ...
  /**
   * Find the Position of the Tile the player currently needs to go to (the goal at first, and the
   * home tile once the goal has been reached).
   */
  ...
  /**
   * Returns a TurnPlan which will result in reaching the given candidate Tile, or returns
